# Manual Setup Steps for Minions Memory
...
Go to **GitHub → mxn2020/minions-memory → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-memory` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-memory-web`
- **GitHub repo**: `mxn2020/minions-memory`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `memory.minions.wtf`

### Documentation
- **Netlify site name**: `minions-memory-docs`
- **GitHub repo**: `mxn2020/minions-memory`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `memory.minions.help`

### Blog
- **Netlify site name**: `minions-memory-blog`
- **GitHub repo**: `mxn2020/minions-memory`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `memory.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `memory.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `memory.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `memory.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-memory/sdk`](https://www.npmjs.com/package/@minions-memory/sdk)
- CLI: [`@minions-memory/cli`](https://www.npmjs.com/package/@minions-memory/cli)
...
Your package: [`minions-memory`](https://pypi.org/project/minions-memory/)
...
| Item | Value |
|------|-------|
| Project | `minions-memory` |
| SDK (npm) | `@minions-memory/sdk` |
| CLI (npm) | `@minions-memory/cli` |
| Python (PyPI) | `minions-memory` |
| GitHub | `github.com/mxn2020/minions-memory` |
| Docs domain | `memory.minions.help` |
| Blog domain | `memory.minions.blog` |
| App domain | `memory.minions.wtf` |
